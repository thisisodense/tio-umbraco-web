angular.module("umbraco").controller("Concorde.RestoreDialogController",
    function($scope, deployService, taskManService, $q, $timeout) {
        ...
        */
                    ...
                    deployService.taskStatus(null)
                        .then(function(taskResponse) {
                            ...
                            if (taskResponse &&
                                ...
                                taskResponse.data.complete !== true) {
        ...
        $scope.restore = function() {
            deployService.pullAndRestoreRemoteContent($scope.environment.destination).then(function(response) {
