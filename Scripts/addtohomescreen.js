...
ath.intl = {
	...
	da_dk: {
		ios: 'Tilføj This Is Odense til din hjemmeskærm: Tryk på %icon og <strong>Føj til hjemmeskærm</strong>.',
		android: 'Tilføj This Is Odense til din startskærm: Åben din browsers indstillinger og tryk <strong>Føj til startskærm</strong>. <small>Find indstillingerne ved at trykke på din telefons menu-knap eller ved at trykke på menu-ikonet <span class="ath-action-icon">icon</span>.</small>',
	},
